            ...
            def height(self, value):
                ...
                def x(self, value):
                    ...
                    def y(self, value):
                        ...
                        Args:
                        value (int): The y-coordinate of the rectangle's
                        position.
                                ...
                                for i in range(self.__height):
                                    ...
                                    def __str__(self):
                                        ...
                                        def update(self, *args, **kwargs):
                                            ...
                                            Args:
                                            *args: A variable-length list of
                                            arguments in the following order:
                                            1st argument should be the id
                                            attribute.
                                            2nd argument should be the width
                                            attribute.
                                            3rd argument should be the height
                                            attribute.
                                            4th argument should be the x
                                            attribute.
                                            5th argument should be the y
                                            attribute.
                                            **kwargs: A dictionary containing
                                            key-value pairs where each key
